...
As the original documentation for SLiMS 9 was largely written in Markdown, PandocGUI was used to convert the Markdown to HTML. 
...
You should secure your installation so that the python script cannot be executed by unauthorised persons, particularly if your server is exposed to the internet. The script SHOULD be executed after any significant changes are made to any of the documentation pages.

gurujim | BSC | 27/06/2026
